...
<p class="legal-note">This policy is provided for transparency about a personal project website. It is not legal advice.</p>`
    ...
    es: {
      ...
      toc: [
        ...
        { id: 'what-we-collect', label: 'Qué recopilamos' },
        { id: 'how-we-use', label: 'Cómo usamos la información' },
        { id: 'storage', label: 'Dónde se almacena la información' },
      ...
      sections: [
        {
          ...
          html: `<p>El Sitio es una guía de viaje editorial y un diario fotográfico creado por <strong>Tim G</strong> (GitHub <a href="https://github.com/TGthms" target="_blank" rel="noopener">@TGthms</a>). Es principalmente un sitio estático: la mayor parte del contenido se entrega como páginas y archivos, y la navegación básica no requiere una cuenta.</p>
<p>Tratamos como “datos personales” cualquier información que te identifique o que pueda vincularse razonablemente contigo. Los datos agregados o puramente técnicos que no puedan identificarte de forma razonable no se consideran datos personales a efectos de esta política.</p>`
        },
        {
          id: 'what-we-collect',
...
<ul>
<li><strong>Preferencias que eliges.</strong> Tema, idioma, unidades (temperatura/distancia), preferencias de movimiento y del cursor, y la calidad de las fotos de la galería pueden guardarse en tu dispositivo con el almacenamiento del navegador (como <code>localStorage</code>). Estos ajustes permanecen en tu dispositivo salvo que borres los datos del sitio.</li>
<li><strong>Datos técnicos del navegador o del alojamiento.</strong> Como la mayoría de los sitios web, la información habitual de las solicitudes (por ejemplo dirección IP, tipo de navegador y URL solicitadas) puede ser procesada por el servicio que aloja o entrega el Sitio (por ejemplo un host estático o CDN) para la entrega, la seguridad y la fiabilidad. No operamos un perfil publicitario separado desde este Sitio.</li>
<li><strong>Información que envías voluntariamente.</strong> Si nos contactas (por ejemplo a través de GitHub o de una página “Sobre mí” externa), recibimos lo que decidas incluir en ese mensaje.</li>
<li><strong>Sin sistema de cuentas.</strong> El Sitio no exige registro, contraseñas ni datos de pago para el uso normal de la guía, la galería o las herramientas.</li>
</ul>`
        },
        {
          id: 'how-we-use',
          ...
          html: `<ul>
<li>Para recordar tus preferencias de visualización y accesibilidad entre visitas en el mismo navegador.</li>
<li>Para ofrecer herramientas interactivas (por ejemplo la conversión de divisas, que puede llamar a una API de tipos de cambio de terceros).</li>
<li>Para operar, asegurar y mejorar la entrega del Sitio a través de la infraestructura de alojamiento.</li>
<li>Para responder si nos contactas.</li>
</ul>
<p><strong>No</strong> vendemos tus datos personales. No usamos el almacenamiento de preferencias del Sitio para publicidad entre sitios.</p>`
        },
        {
          id: 'storage',
          title: 'Dónde se almacena la información',
          html: `<p>Los datos de preferencias se guardan <strong>localmente en tu dispositivo</strong> mediante el navegador. Los proveedores de alojamiento pueden procesar registros de conexión en las regiones donde se encuentra su infraestructura. Si el Sitio se sirve desde un repositorio público o un host estático (por ejemplo GitHub Pages), también se aplican sus respectivos términos de privacidad a ese alojamiento.</p>`
        },
        {
          id: 'third-parties',
          title: 'Servicios de terceros',
          html: `<p>El Sitio puede cargar o contactar servicios de terceros necesarios para funciones que uses:</p>
<ul>
...
<li><strong>Enlaces externos / de salida.</strong> Por comodidad, el Sitio incluye enlaces a sitios de terceros—incluidas oficinas oficiales de turismo de ciudades, agencias de transporte público, páginas del National Park Service, museos, GitHub, Sobre mí y recursos similares (por ejemplo “Enlaces útiles” en las tarjetas de destinos). Al hacer clic, abandonas el Sitio y pasas a un servicio que no operamos. Esos operadores pueden recopilar información según sus propias políticas de privacidad; esta política no los cubre. No recibimos tu actividad en esos sitios externos solo por el hecho del enlace, y un enlace no implica respaldo ni control sobre ese tercero.</li>
        ...
        },
        {
          ...
          html: `<p>El Sitio usa principalmente el <strong>almacenamiento local del navegador</strong> para preferencias, no cookies publicitarias. Tu navegador o el host pueden usar cookies o tecnologías similares por seguridad, equilibrio de carga o continuidad de sesión. Puedes borrar los datos del sitio o bloquear el almacenamiento en la configuración del navegador; en ese caso algunas preferencias se reiniciarán en cada visita.</p>`
        },
        {
          id: 'choices',
          title: 'Tus opciones',
          html: `<ul>
<li>Cambia tema, idioma, unidades, movimiento y calidad de la galería en cualquier momento en <strong>Ajustes</strong>.</li>
<li>Borra los datos del sitio en el navegador para eliminar las preferencias locales.</li>
<li>Desactiva el acceso de red a fuentes o API de terceros si lo prefieres; algunas funciones pueden degradarse.</li>
<li>Contáctanos (abajo) con preguntas de privacidad sobre este Sitio.</li>
</ul>`
        },
        {
          id: 'children',
          title: 'Menores',
          html: `<p>El Sitio es un recurso general de información de viajes y no está dirigido a menores de 13 años (o la edad mínima equivalente en tu jurisdicción). No recopilamos a sabiendas datos personales de menores a través de este Sitio. Si crees que un menor ha proporcionado datos personales, contáctanos para que podamos actuar de forma adecuada.</p>`
        },
        {
          id: 'changes',
          title: 'Cambios en esta política',
          html: `<p>Podemos actualizar esta Política de privacidad de vez en cuando. Cuando lo hagamos, revisaremos la fecha de “Actualizado” al inicio de esta página. El uso continuado del Sitio tras los cambios implica que reconoces la política actualizada. Los cambios materiales pueden destacarse en el Sitio cuando sea práctico.</p>`
        },
        {
          id: 'contact',
          title: 'Contacto',
          html: `<p>Para preguntas sobre esta Política de privacidad o las prácticas de privacidad del Sitio, escribe a través de:</p>
<ul>
<li><a href="mailto:contact.timg@icloud.com">contact.timg@icloud.com</a></li>
<li><a href="https://github.com/TGthms/usa-travel-guide" target="_blank" rel="noopener">Repositorio de GitHub</a></li>
</ul>
<p class="legal-note">Esta política se ofrece para transparencia sobre un sitio de proyecto personal. No constituye asesoramiento legal.</p>`
        }
      ],
      footerNote: '© 2026 USA Travel Guide · Tim G (TGthms)'
    },
    zh: {
      ...
      onThisPage: '本页目录',
      lead: '本《隐私政策》说明<strong>美国 — 旅行指南</strong>（以下简称“本网站”“我们”）在您访问或使用本网站（包括指南、相册与工具）时如何处理相关信息。我们尽量在少收集个人数据的前提下提供服务。',
      toc: [
        { id: 'overview', label: '概述' },
        { id: 'what-we-collect', label: '我们收集哪些信息' },
        { id: 'how-we-use', label: '我们如何使用信息' },
        { id: 'storage', label: '信息存储位置' },
        { id: 'third-parties', label: '第三方服务' },
        { id: 'cookies', label: 'Cookie 与类似技术' },
        { id: 'choices', label: '您的选择' },
        { id: 'children', label: '儿童' },
        { id: 'changes', label: '政策变更' },
      ...
      sections: [
        {
          id: 'overview',
          title: '概述',
          html: `<p>本网站是由 <strong>Tim G</strong>（GitHub <a href="https://github.com/TGthms" target="_blank" rel="noopener">@TGthms</a>）创作的编辑型旅行指南与影像手记。网站以静态内容为主：大部分内容以页面与文件形式交付，核心浏览无需注册账户。</p>
<p>我们将任何可识别您身份、或可合理关联到您的信息视为“个人数据”。无法合理识别个人的汇总数据或纯技术数据，在本政策中不视为个人数据。</p>`
        },
        {
          id: 'what-we-collect',
          title: '我们收集哪些信息',
          html: `<p>根据您的使用方式，可能涉及以下信息：</p>
<ul>
<li><strong>您选择的偏好设置。</strong>主题、语言、单位（温度/距离）、动效与光标偏好、相册画质等，可能通过浏览器本地存储（例如 <code>localStorage</code>）保存在您的设备上。除非您清除网站数据，这些设置会保留在本机。</li>
<li><strong>浏览器或主机处理的技术数据。</strong>与大多数网站一样，托管或分发本网站的服务（例如静态托管或 CDN）可能处理标准请求信息（如 IP 地址、浏览器类型、请求 URL），用于交付、安全与可靠性。我们不会基于本网站建立独立的广告画像。</li>
<li><strong>您主动发送的信息。</strong>若您通过 GitHub 或外部“关于我”页面联系我们，我们会收到您在消息中自愿提供的内容。</li>
<li><strong>无账户系统。</strong>正常使用指南、相册或工具时，不需要注册、密码或支付信息。</li>
</ul>`
        },
        {
          id: 'how-we-use',
          title: '我们如何使用信息',
          html: `<ul>
<li>在同一浏览器中记住您的显示与无障碍偏好。</li>
<li>提供互动工具（例如货币换算，可能调用第三方汇率 API）。</li>
<li>通过托管基础设施运营、保障并改进网站交付。</li>
<li>在您联系我们时作出回应。</li>
</ul>
<p>我们<strong>不会</strong>出售您的个人数据，也不会将本网站的偏好存储用于跨站广告。</p>`
        },
        {
          id: 'storage',
          title: '信息存储位置',
          html: `<p>偏好数据由浏览器<strong>保存在您的本地设备</strong>。托管服务商可能在其基础设施所在地区处理连接日志。若网站通过公共仓库或静态托管（例如 GitHub Pages）提供，相关托管方的隐私条款同样适用。</p>`
        },
        {
          id: 'third-parties',
          title: '第三方服务',
          html: `<p>为实现您使用的功能，本网站可能加载或访问第三方服务：</p>
<ul>
...
<li><strong>外部／外链网站。</strong>为方便使用，本网站会提供指向第三方网站的链接——包括城市官方旅游局、公共交通机构、国家公园管理局页面、博物馆、GitHub、关于我以及类似资源（例如目的地卡片中的“实用链接”）。点击此类链接即离开本网站，进入我们不运营的服务。这些运营方可能按其自身隐私政策收集信息；本政策不涵盖它们。我们不会仅因链接本身而获得您在那些外部网站上的活动，且链接并不表示我们认可或控制该第三方。</li>
        ...
        },
        {
          id: 'cookies',
          title: 'Cookie 与类似技术',
          html: `<p>本网站主要使用<strong>本地浏览器存储</strong>保存偏好，而非广告 Cookie。您的浏览器或主机仍可能因安全、负载均衡或会话连续性使用 Cookie 或类似技术。您可在浏览器中清除网站数据或阻止存储；部分偏好将在每次访问时重置。</p>`
        },
        {
          id: 'choices',
          title: '您的选择',
...
<li>在浏览器中清除网站数据以删除本地偏好。</li>
<li>如需，可阻止第三方字体或 API 的网络访问；部分功能可能受限。</li>
<li>就本网站隐私问题通过下方方式联系我们。</li>
</ul>`
        },
        {
          id: 'children',
          title: '儿童',
          html: `<p>本网站为一般旅行信息内容，不针对 13 岁以下儿童（或以您所在法域规定的同等最低年龄为准）。我们不会通过本网站故意收集儿童个人数据。若您认为儿童提供了个人数据，请联系我们以便妥善处理。</p>`
        },
        {
          id: 'changes',
          title: '政策变更',
          html: `<p>我们可能不时更新本《隐私政策》。更新时会修改页面顶部的“更新日期”。变更后继续使用本网站，即表示您知悉更新后的政策。重大变更在可行时会在网站上提示。</p>`
        },
        {
          id: 'contact',
          title: '联系我们',
          html: `<p>如对本《隐私政策》或本网站隐私实践有疑问，请通过以下方式联系：</p>
<ul>
<li><a href="mailto:contact.timg@icloud.com">contact.timg@icloud.com</a></li>
<li><a href="https://github.com/TGthms/usa-travel-guide" target="_blank" rel="noopener">GitHub 仓库</a></li>
</ul>
<p class="legal-note">本政策旨在说明个人项目网站的透明度安排，不构成法律意见。</p>`
        }
      ],
      footerNote: '© 2026 USA Travel Guide · Tim G (TGthms)'
    },
      ...
      sections: [
        {
          id: 'overview',
          title: '概要',
          html: `<p>本サイトは <strong>Tim G</strong>（GitHub <a href="https://github.com/TGthms" target="_blank" rel="noopener">@TGthms</a>）による編集型の旅行ガイド兼フォトジャーナルです。主に静的サイトとして提供され、大半のコンテンツはページとファイルとして配信されます。基本的な閲覧にアカウントは不要です。</p>
<p>当方は、お客様を識別する情報、または合理的にお客様に結び付けられる情報を「個人データ」として扱います。個人を合理的に特定できない集計データや純粋な技術データは、本ポリシー上の個人データには含みません。</p>`
        },
        {
          id: 'what-we-collect',
          title: '収集する情報',
          html: `<p>ご利用状況に応じて、次のような情報が関わる場合があります。</p>
<ul>
<li><strong>お客様が選ぶ設定。</strong> テーマ、言語、単位（気温・距離）、モーション／カーソル設定、ギャラリー画質などは、ブラウザの保存領域（例：<code>localStorage</code>）により端末に保存されることがあります。サイトデータを消去しない限り端末に残ります。</li>
<li><strong>ブラウザまたはホストが処理する技術データ。</strong> 多くのウェブサイトと同様、配信・セキュリティ・信頼性のため、ホスト／CDN 等が標準的なリクエスト情報（IP アドレス、ブラウザ種別、要求 URL など）を処理する場合があります。本サイトから別途の広告プロフィールを構築することはありません。</li>
<li><strong>任意で送信される情報。</strong> GitHub や外部の About ページ等からご連絡いただいた場合、その内容に含まれる情報を受領します。</li>
<li><strong>アカウント不要。</strong> ガイド・ギャラリー・ツールの通常利用に登録・パスワード・決済情報は不要です。</li>
</ul>`
        },
        {
          id: 'how-we-use',
          title: '情報の利用目的',
          html: `<ul>
<li>同一ブラウザでの表示・アクセシビリティ設定の記憶</li>
<li>インタラクティブなツールの提供（例：通貨換算。第三者の為替 API を呼び出す場合があります）</li>
<li>ホスティング基盤を通じたサイトの運用・保護・配信改善</li>
<li>お問い合わせへの対応</li>
</ul>
<p>個人データを<strong>販売しません</strong>。本サイトの設定保存をクロスサイト広告に使用しません。</p>`
        },
        {
          id: 'storage',
          title: '情報の保管場所',
          html: `<p>設定データはブラウザにより<strong>お客様の端末上にローカル保存</strong>されます。ホスティング事業者は、そのインフラが所在する地域で接続ログを処理する場合があります。公開リポジトリや静的ホスト（例：GitHub Pages）経由で提供される場合、当該ホストのプライバシー条件も適用されます。</p>`
        },
        {
          id: 'third-parties',
          title: '第三者サービス',
          html: `<p>ご利用機能のために、次のような第三者サービスを読み込む／接続する場合があります。</p>
<ul>
...
<li><strong>外部／アウトバウンドリンク。</strong> 便宜のため、本サイトは第三者ウェブサイトへのリンクを含みます。都市の公式観光局、公共交通機関、National Park Service のページ、博物館、GitHub、About Me、および同様のリソース（例：目的地カードの「役立つリンク」）が含まれます。そのようなリンクをクリックすると本サイトを離れ、当方が運営していないサービスへ移動します。各運営者は独自のプライバシーポリシーに基づき情報を収集する場合があり、本ポリシーの対象外です。リンクがあること自体により、当方がそれらの外部サイト上でのお客様の行動を受け取ることはなく、リンクは当該第三者の推奨や管理を意味しません。</li>
        ...
        },
        {
          id: 'cookies',
          title: 'Cookie 等の技術',
          html: `<p>本サイトは主に設定のために<strong>ローカルのブラウザ保存</strong>を用い、広告 Cookie を主目的とはしません。ブラウザやホストは、セキュリティ、負荷分散、セッション維持のために Cookie 等を用いる場合があります。ブラウザでサイトデータを消去したり保存をブロックしたりできます（その場合、一部設定は訪問のたびにリセットされます）。</p>`
        },
        {
          id: 'choices',
          title: 'お客様の選択肢',
          html: `<ul>
<li><strong>設定</strong>でテーマ・言語・単位・モーション・ギャラリー画質をいつでも変更できます。</li>
<li>ブラウザでサイトデータを消去し、ローカル設定を削除できます。</li>
<li>第三者フォント／API への通信を制限することもできます（一部機能が制限される場合があります）。</li>
<li>本サイトのプライバシーに関するご質問は下記まで。</li>
</ul>`
        },
        {
          id: 'children',
          title: 'お子様について',
          html: `<p>本サイトは一般的な旅行情報であり、13 歳未満（またはお住まいの法域で定められる同等の最低年齢）のお子様を対象としていません。本サイトを通じて故意にお子様の個人データを収集することはありません。お子様の個人データが提供されたと思われる場合はご連絡ください。</p>`
        },
        {
          id: 'changes',
          title: '本ポリシーの変更',
          html: `<p>本プライバシーポリシーは随時更新される場合があります。更新時はページ上部の「更新日」を改めます。変更後も本サイトをご利用いただくことは、更新後のポリシーを認識したものとみなします。重要な変更は、可能な範囲でサイト上でお知らせします。</p>`
        },
        {
          id: 'contact',
          title: 'お問い合わせ',
          html: `<p>本プライバシーポリシーまたは本サイトのプライバシー慣行に関するご質問は、次の方法でご連絡ください。</p>
<ul>
<li><a href="mailto:contact.timg@icloud.com">contact.timg@icloud.com</a></li>
...
<p class="legal-note">These Terms are written for a personal travel-guide project and are not a substitute for legal advice.</p>`
    ...
    es: {
      ...
      toc: [
        ...
        { id: 'software', label: 'Software y código del Sitio' },
        { id: 'travel', label: 'Aviso sobre información de viaje' },
        { id: 'acceptable-use', label: 'Uso aceptable' },
        { id: 'third-party', label: 'Enlaces y herramientas de terceros' },
        { id: 'privacy', label: 'Privacidad' },
        { id: 'disclaimers', label: 'Exenciones de responsabilidad' },
      ...
      sections: [
        {
          ...
          html: `<p>Estos Términos se aplican al Sitio tal como se pone a disposición en línea (incluido cualquier espejo o alojamiento estático del proyecto). Podemos actualizar estos Términos publicando una versión revisada en esta página y actualizando la fecha anterior. El uso continuado tras los cambios constituye la aceptación de los Términos revisados.</p>
<p>Mientras cumplas estos Términos, te otorgamos un derecho personal, no exclusivo, intransferible y limitado de acceder y usar el Sitio con fines personales y no comerciales.</p>`
        },
        {
          id: 'ownership',
          title: 'Titularidad del Sitio',
          html: `<p>El Sitio —incluido su texto, diseño, interfaz, logotipos, gráficos, compilación de contenidos y material editorial original— es propiedad de Tim G / TGthms o se usa bajo licencia, y está protegido por derechos de autor y otras leyes de propiedad intelectual.</p>
<p>Salvo lo expresamente permitido en estos Términos o bajo una licencia abierta indicada para un componente concreto, no puedes copiar, reproducir, republicar, cargar, publicar, exhibir públicamente, codificar, traducir, transmitir ni distribuir ninguna parte del Sitio con fines comerciales sin permiso previo por escrito.</p>`
        },
        {
          id: 'photos',
          title: 'Fotografías y contenido visual',
          html: `<p>Las fotografías y obras visuales relacionadas en la galería y en el resto del Sitio (incluidos los archivos bajo <code>images/</code>) son <strong>© 2026 Tim G (GitHub @TGthms)</strong>, salvo que se indique otro crédito para una obra concreta.</p>
<p>Esas fotografías se ofrecen bajo la licencia <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener">Creative Commons Atribución 4.0 Internacional (CC BY 4.0)</a>. En términos sencillos, puedes compartir y adaptar las fotos —incluso con fines comerciales— siempre que:</p>
<ul>
<li>Des crédito adecuado a <strong>Tim G / @TGthms</strong>;</li>
<li>Enlaces a la licencia CC BY 4.0 cuando sea práctico;</li>
<li>Indiques si se hicieron cambios; y</li>
<li>No sugieras que el autor te respalda a ti ni a tu uso.</li>
</ul>
<p>Atribución sugerida: <em>“Foto © Tim G (@TGthms), con licencia CC BY 4.0.”</em></p>
<p>No se permite eliminar marcas de agua, atribuir falsamente o usar las fotos de forma que viole la ley aplicable. Si necesitas derechos más allá de CC BY 4.0, contáctanos.</p>`
        },
        {
          id: 'software',
          title: 'Software y código del Sitio',
          html: `<p>El código fuente del proyecto del Sitio puede publicarse bajo una licencia de código abierto (por ejemplo la <a href="https://github.com/TGthms/usa-travel-guide" target="_blank" rel="noopener">licencia MIT</a> del repositorio). Las licencias de código abierto rigen el software; <strong>no</strong> colocan automáticamente las fotografías bajo la misma licencia. Los derechos de las fotos siguen siendo los descritos arriba, salvo que el aviso de un archivo indique lo contrario.</p>`
        },
        {
          id: 'travel',
          title: 'Aviso sobre información de viaje',
          html: `<p>El contenido del Sitio —incluidos destinos, estaciones, rutas, consejos, notas de visado, costes, herramientas e información práctica— se ofrece solo con fines <strong>informativos y educativos generales</strong>. No es asesoramiento profesional legal, de inmigración, médico, financiero ni de seguridad.</p>
<ul>
...
<p>Asumes plena responsabilidad por las decisiones que tomes basándote en el Sitio. No somos responsables de pérdidas derivadas de la confianza en el contenido del Sitio.</p>`
        },
        {
          ...
          html: `<p>Aceptas no:</p>
<ul>
<li>Usar el Sitio con fines ilícitos o en violación de estos Términos;</li>
<li>Intentar obtener acceso no autorizado a sistemas, cuentas o redes relacionados con el Sitio;</li>
<li>Sondear, escanear o someter a estrés el Sitio de forma que degrade el servicio para otros;</li>
<li>Extraer o descargar masivamente el Sitio de manera que imponga una carga irrazonable o eluda controles de acceso, salvo lo permitido por robots o una licencia abierta;</li>
<li>Falsear tu afiliación con el Sitio o su autor; o</li>
<li>Usar el contenido de forma que infrinja derechos de propiedad intelectual o privacidad de terceros.</li>
</ul>`
        },
        {
          id: 'third-party',
...
<p>Si un enlace de terceros está roto, desactualizado o es inapropiado, puedes contactarnos para que consideremos una actualización; no estamos obligados a mantener ninguna URL externa concreta.</p>`
        },
        {
          id: 'privacy',
          title: 'Privacidad',
          html: `<p>Nuestra <a href="privacy.html">Política de privacidad</a> explica cómo el Sitio trata la información. Se incorpora a estos Términos por referencia. Al usar el Sitio, también reconoces que las transmisiones por internet nunca son completamente privadas ni seguras.</p>`
        },
        {
          id: 'disclaimers',
          title: 'Exenciones de responsabilidad',
          html: `<p>EL SITIO Y TODO SU CONTENIDO SE OFRECEN “TAL CUAL” Y “SEGÚN DISPONIBILIDAD”. EN LA MÁXIMA MEDIDA PERMITIDA POR LA LEY, RENUNCIAMOS A TODAS LAS GARANTÍAS, EXPRESAS O IMPLÍCITAS, INCLUIDAS COMERCIABILIDAD, IDONEIDAD PARA UN FIN PARTICULAR, TITULARIDAD Y NO INFRACCIÓN. NO GARANTIZAMOS QUE EL SITIO SEA ININTERRUMPIDO, LIBRE DE ERRORES O DE COMPONENTES DAÑINOS, NI QUE SE CORRIJAN LOS DEFECTOS.</p>
<p>La información del Sitio puede cambiar sin previo aviso. No tenemos obligación de actualizar ninguna página o herramienta concreta.</p>`
        },
        {
          id: 'liability',
          title: 'Limitación de responsabilidad',
          html: `<p>En la máxima medida permitida por la ley, Tim G / TGthms y los colaboradores del Sitio no serán responsables de daños indirectos, incidentales, especiales, consecuentes o punitivos, ni de pérdida de beneficios, datos o clientela, derivados del uso (o la imposibilidad de uso) del Sitio, incluso si se advirtió de la posibilidad de tales daños.</p>`
        },
        {
          id: 'changes',
          title: 'Cambios en el Sitio',
          html: `<p>Podemos modificar, suspender o discontinuar cualquier parte del Sitio en cualquier momento sin previo aviso, incluso por mantenimiento, rediseño o dirección del proyecto. No estamos obligados a seguir alojando una función o foto concreta.</p>`
        },
        {
          id: 'contact',
          title: 'Contacto',
          html: `<p>Preguntas sobre estos Términos, licencias de fotos o permisos:</p>
<ul>
<li><a href="mailto:contact.timg@icloud.com">contact.timg@icloud.com</a></li>
<li><a href="https://github.com/TGthms/usa-travel-guide" target="_blank" rel="noopener">Repositorio de GitHub</a></li>
</ul>
<p class="legal-note">Estos Términos se redactan para un proyecto personal de guía de viaje y no sustituyen el asesoramiento legal.</p>`
        }
      ],
      footerNote: '© 2026 USA Travel Guide · Tim G (TGthms). Todos los derechos reservados salvo donde apliquen licencias abiertas.'
    },
    zh: {
      title: '使用条款',
      eyebrow: '法律信息',
      ...
      toc: [
        { id: 'agreement', label: '同意条款' },
        { id: 'ownership', label: '网站所有权' },
      ...
      sections: [
        {
          id: 'agreement',
          title: '同意条款',
          html: `<p>本条款适用于在线提供的本网站（包括项目的任何镜像或静态托管）。我们可能不时通过在本页发布修订版并更新上述日期来更新条款。变更后继续使用即表示接受修订后的条款。</p>
<p>在您遵守本条款的前提下，我们授予您个人、非排他、不可转让的有限权利，仅为个人、非商业目的访问和使用本网站。</p>`
        },
        {
          id: 'ownership',
          title: '网站所有权',
          html: `<p>本网站——包括文本、版式、设计、用户界面、标识、图形、内容汇编及原创编辑材料——归 Tim G / TGthms 所有或经许可使用，并受版权及其他知识产权法律保护。</p>
<p>除非本条款明确允许，或特定组件另有开放许可说明，否则未经事先书面许可，不得为商业目的复制、转载、上传、发布、公开展示、编码、翻译、传输或分发本网站的任何部分。</p>`
        },
        {
          id: 'photos',
          title: '照片与视觉内容',
          html: `<p>相册及本网站其他位置的照片及相关视觉作品（包括 <code>images/</code> 下的文件）版权为 <strong>© 2026 Tim G（GitHub @TGthms）</strong>，除非某作品另有署名。</p>
<p>上述照片根据 <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener">知识共享署名 4.0 国际（CC BY 4.0）</a> 许可提供。简言之，您可分享与改编照片（包括商业用途），但须：</p>
<ul>
<li>向 <strong>Tim G / @TGthms</strong> 给予适当署名；</li>
<li>在可行时提供 CC BY 4.0 许可链接；</li>
<li>说明是否进行了修改；以及</li>
<li>不得暗示作者认可您或您的使用方式。</li>
</ul>
<p>建议署名：<em>“照片 © Tim G (@TGthms)，CC BY 4.0 许可。”</em></p>
<p>不得去除水印、虚假署名或以违反适用法律的方式使用照片。若需超出 CC BY 4.0 的权利，请联系我们。</p>`
        },
        {
          id: 'software',
          title: '网站软件与代码',
          html: `<p>本网站项目的源代码可能以开源许可发布（例如仓库附带的 <a href="https://github.com/TGthms/usa-travel-guide" target="_blank" rel="noopener">MIT 许可</a>）。开源许可约束软件本身，<strong>不会</strong>自动使照片适用同一许可。除非文件另有说明，照片权利仍以上文为准。</p>`
        },
        {
          id: 'travel',
          title: '旅行信息免责声明',
          html: `<p>本网站内容——包括目的地、季节、路线、贴士、签证说明、费用、工具与实用信息——仅供<strong>一般信息与教育目的</strong>。不构成专业法律、移民、医疗、财务或安全建议。</p>
<ul>
...
<p>若第三方链接失效、过时或不适当，可联系我们以便考虑更新；我们无义务维持任何特定外部 URL。</p>`
        },
        {
          id: 'privacy',
          title: '隐私',
          html: `<p>我们的<a href="privacy.html">隐私政策</a>说明本网站如何处理信息，并通过引用纳入本条款。使用本网站即表示您亦知悉互联网传输并非完全私密或安全。</p>`
        },
        {
          id: 'disclaimers',
          title: '免责声明',
          html: `<p>本网站及全部内容按“现状”和“可用”基础提供。在法律允许的最大范围内，我们不作任何明示或默示保证，包括适销性、特定用途适用性、权属与不侵权。我们不保证网站不中断、无错误、无有害组件，或缺陷将被纠正。</p>
<p>网站信息可能不经通知而变更。我们无义务更新任何特定页面或工具。</p>`
        },
        {
          id: 'liability',
          title: '责任限制',
          html: `<p>在法律允许的最大范围内，Tim G / TGthms 及本网站贡献者不对因您使用（或无法使用）本网站而产生的任何间接、附带、特殊、后果性或惩罚性损害，或利润、数据或商誉损失承担责任——即使已被告知可能发生此类损害。</p>`
        },
        {
          id: 'changes',
          title: '网站变更',
          html: `<p>我们可随时不经通知修改、暂停或终止本网站任何部分，包括为了维护、改版或项目方向。我们无义务继续托管任何特定功能或照片。</p>`
        },
        {
          id: 'contact',
          title: '联系我们',
          html: `<p>关于本条款、照片许可或授权的问题：</p>
<ul>
<li><a href="mailto:contact.timg@icloud.com">contact.timg@icloud.com</a></li>
<li><a href="https://github.com/TGthms/usa-travel-guide" target="_blank" rel="noopener">GitHub 仓库</a></li>
</ul>
<p class="legal-note">本条款为个人旅行指南项目而撰写，不能替代法律意见。</p>`
      ...
      footerNote: '© 2026 USA Travel Guide · Tim G (TGthms)。除开放许可适用处外，保留所有权利。'
    },
    ja: {
      title: '利用規約',
      eyebrow: 'リーガル',
      ...
      toc: [
        ...
        { id: 'ownership', label: '本サイトの権利帰属' },
        { id: 'photos', label: '写真およびビジュアルコンテンツ' },
        { id: 'software', label: 'ソフトウェアとコード' },
        { id: 'travel', label: '旅行情報に関する免責' },
        { id: 'acceptable-use', label: '利用上の禁止事項' },
      ...
      sections: [
        {
          id: 'agreement',
          title: '規約への同意',
          html: `<p>本規約は、オンラインで提供される本サイト（プロジェクトのミラーや静的ホスティングを含む）に適用されます。当方は、本ページに改訂版を掲載し上記日付を更新することにより、随時本規約を更新できます。変更後の継続利用は改訂規約への同意を意味します。</p>
<p>本規約を遵守する限り、個人的・非商業的目的での本サイトへのアクセスおよび利用に関する、個人的・非独占的・譲渡不能・限定的な権利を付与します。</p>`
        },
        {
          id: 'ownership',
          title: '本サイトの権利帰属',
          html: `<p>本サイト（テキスト、レイアウト、デザイン、UI、ロゴ、グラフィック、コンテンツの編集・構成、オリジナルの編集素材を含む）は Tim G / TGthms が所有するかライセンスに基づき使用され、著作権その他の知的財産法により保護されます。</p>
<p>本規約で明示的に許された場合、または特定コンポーネントに示されたオープンライセンスがある場合を除き、事前の書面による許可なく、商業目的で本サイトの一部を複製、再公開、アップロード、掲示、公に表示、符号化、翻訳、送信、配布してはなりません。</p>`
        },
        {
          id: 'photos',
          title: '写真およびビジュアルコンテンツ',
          html: `<p>ギャラリーその他本サイト上の写真および関連ビジュアル作品（<code>images/</code> 配下のファイルを含む）は、個別のクレジットがない限り <strong>© 2026 Tim G（GitHub @TGthms）</strong> です。</p>
<p>これらの写真は <a href="https://creativecommons.org/licenses/by/4.0/" target="_blank" rel="noopener">クリエイティブ・コモンズ 表示 4.0 国際（CC BY 4.0）</a> のもとで提供されます。平易に言えば、次を条件に写真の共有・翻案（商用利用を含む）が可能です。</p>
<ul>
...
<p>透かしの除去、虚偽の帰属表示、適用法に違反する利用は禁止です。CC BY 4.0 を超える権利が必要な場合はご連絡ください。</p>`
        },
        {
          id: 'software',
          title: 'ソフトウェアとコード',
          html: `<p>本サイトプロジェクトのソースコードは、オープンソースライセンス（例：リポジトリ付属の <a href="https://github.com/TGthms/usa-travel-guide" target="_blank" rel="noopener">MIT ライセンス</a>）で公開される場合があります。オープンソースライセンスはソフトウェアに適用され、写真を自動的に同じライセンス下に置くものでは<strong>ありません</strong>。ファイルの表示がない限り、写真の権利は上記のとおりです。</p>`
        },
        {
          id: 'travel',
          title: '旅行情報に関する免責',
          html: `<p>本サイトのコンテンツ（目的地、季節、ルート、ヒント、ビザ関連、費用、ツール、実用情報を含む）は、<strong>一般的な情報・教育目的</strong>のみで提供されます。専門の法律・出入国・医療・金融・安全に関する助言ではありません。</p>
<ul>
...
<p>第三者リンクが壊れている、古い、または不適切である場合はご連絡ください（更新を検討します）。特定の外部 URL を維持する義務は負いません。</p>`
        },
        {
          id: 'privacy',
          title: 'プライバシー',
          html: `<p>本サイトの情報の取り扱いは <a href="privacy.html">プライバシーポリシー</a> に説明があり、参照により本規約に組み込まれます。本サイトの利用により、インターネット通信が完全に私的・安全ではないことも認識したものとみなします。</p>`
        },
        {
          id: 'disclaimers',
          title: '免責事項',
          html: `<p>本サイトおよびすべてのコンテンツは「現状有姿」「提供可能な範囲」で提供されます。法律で認められる最大限の範囲で、商品性、特定目的適合性、権原、非侵害を含む明示・黙示の保証をすべて否認します。本サイトが中断なく、エラーなく、有害な要素がなく、欠陥が修正されることを保証しません。</p>
<p>本サイトの情報は予告なく変更される場合があります。特定のページやツールを更新する義務を負いません。</p>`
        },
        {
          id: 'liability',
          title: '責任の制限',
          html: `<p>法律で認められる最大限の範囲で、Tim G / TGthms および本サイトの貢献者は、本サイトの利用（または利用不能）に関連して生じた間接・付随・特別・結果的・懲罰的損害、または利益・データ・信用の損失について、たとえその可能性を通知されていたとしても責任を負いません。</p>`
        },
        {
          id: 'changes',
          title: '本サイトの変更',
          html: `<p>当方は、保守、再設計、プロジェクト方針等のため、予告なく本サイトの一部を変更・停止・終了できます。特定の機能や写真のホスティングを継続する義務は負いません。</p>`
        },
        {
          id: 'contact',
          title: 'お問い合わせ',
          html: `<p>本規約、写真ライセンス、許諾に関するご質問：</p>
<ul>
<li><a href="mailto:contact.timg@icloud.com">contact.timg@icloud.com</a></li>
<li><a href="https://github.com/TGthms/usa-travel-guide" target="_blank" rel="noopener">GitHub リポジトリ</a></li>
</ul>

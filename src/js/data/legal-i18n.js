    ...
    "en": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "html": "<p>Photographs and related visual works in the gallery and elsewhere on the Site (including files under <code>images/</code>) are <strong>© {year} Tim G (GitHub @TGthms)</strong> unless a different credit is shown for a specific work.</p>\n<p>Those photographs are made available under the <a href=\"https://creativecommons.org/licenses/by-nc/4.0/\" target=\"_blank\" rel=\"noopener\">Creative Commons Attribution-NonCommercial 4.0 International (CC BY-NC 4.0)</a> license. In plain language, you may share and adapt the photos for <strong>non-commercial purposes only</strong>, provided that you:</p>\n<ul>\n<li>Give appropriate credit to <strong>Tim G / @TGthms</strong>;</li>\n<li>Provide a link to the CC BY-NC 4.0 license where practical;</li>\n<li>Indicate if changes were made; and</li>\n<li>Do not suggest that the author endorses you or your use.</li>\n</ul>\n<p>Commercial use (for example, selling prints, using a photo in advertising, or on a monetized site) is <strong>not permitted</strong> without prior written permission.</p>\n<p>Suggested attribution: <em>“Photo © Tim G (@TGthms), licensed under CC BY-NC 4.0.”</em></p>\n<p>Removing watermarks, false attribution, or using photos in a way that violates applicable law is not permitted. If you need rights beyond CC BY-NC 4.0, contact us.</p>"
        },
        {
          "id": "software",
    ...
    "es": {
      ...
      "sections": [
        ...
        },
        {
          ...
          "html": "<p>Las fotos y obras visuales de la galería y del resto del Sitio (incluido <code>images/</code>), salvo que se indique otro crédito, son <strong>© {year} Tim G (GitHub @TGthms)</strong>.</p>\n<p>Se ofrecen bajo <a href=\"https://creativecommons.org/licenses/by-nc/4.0/\" target=\"_blank\" rel=\"noopener\">Creative Commons Atribución-NoComercial 4.0 Internacional (CC BY-NC 4.0)</a>. En la práctica, puedes compartir y adaptar las fotos <strong>solo con fines no comerciales</strong>, si:</p>\n<ul>\n<li>das crédito a <strong>Tim G / @TGthms</strong>;</li>\n<li>enlazas a CC BY-NC 4.0 cuando sea razonable;</li>\n<li>indicas si hiciste cambios; y</li>\n<li>no insinúas que el autor respalda tu uso.</li>\n</ul>\n<p>El uso comercial (por ejemplo, vender copias, usarlas en publicidad o en un sitio monetizado) <strong>no está permitido</strong> sin permiso previo por escrito.</p>\n<p>Crédito sugerido: <em>«Foto © Tim G (@TGthms), con licencia CC BY-NC 4.0.»</em></p>\n<p>No quites marcas de agua, no atribuyas de forma falsa ni uses las fotos de forma ilegal. Si necesitas derechos más amplios que CC BY-NC 4.0, contáctanos.</p>"
        },
        {
          "id": "software",
    ...
    "zh": {
      ...
      "sections": [
        ...
        },
        {
          "id": "photos",
          "title": "照片与视觉作品",
          "html": "<p>相册及本站其他位置的照片与相关视觉作品（含 <code>images/</code> 目录），除非另有署名，版权均为 <strong>© {year} Tim G（GitHub @TGthms）</strong>。</p>\n<p>这些照片采用 <a href=\"https://creativecommons.org/licenses/by-nc/4.0/\" target=\"_blank\" rel=\"noopener\">知识共享 署名-非商业性使用 4.0 国际（CC BY-NC 4.0）</a> 许可。简单说：你可以<strong>仅出于非商业目的</strong>分享、修改这些照片，但需要：</p>\n<ul>\n<li>标明作者 <strong>Tim G / @TGthms</strong>；</li>\n<li>在可行时附上 CC BY-NC 4.0 链接；</li>\n<li>说明是否做了修改；</li>\n<li>不要暗示作者认可你或你的用途。</li>\n</ul>\n<p>未经事先书面许可，<strong>不得将照片用于商业用途</strong>（例如出售照片、用于广告，或用于已实现盈利的网站）。</p>\n<p>推荐署名示例：<em>「照片 © Tim G (@TGthms)，采用 CC BY-NC 4.0 许可。」</em></p>\n<p>请勿去除水印、虚假署名，或以违法方式使用照片。若需要超出 CC BY-NC 4.0 的授权，请联系我们。</p>"
        },
        {
          "id": "software",
          "title": "软件与代码",
    ...
    "ja": {
      ...
      "sections": [
        ...
        },
        {
          "id": "photos",
          "title": "写真・ビジュアル",
          "html": "<p>ギャラリー等の写真・関連ビジュアル（<code>images/</code> 配下を含む）は、別クレジットがない限り <strong>© {year} Tim G（GitHub @TGthms）</strong> です。</p>\n<p><a href=\"https://creativecommons.org/licenses/by-nc/4.0/\" target=\"_blank\" rel=\"noopener\">クリエイティブ・コモンズ 表示-非営利 4.0 国際（CC BY-NC 4.0）</a> で提供しています。要するに、次を守れば<strong>非営利目的に限り</strong>共有や改変が可能です。</p>\n<ul>\n<li><strong>Tim G / @TGthms</strong> に適切なクレジットを付ける</li>\n<li>可能なら CC BY-NC 4.0 へのリンクを示す</li>\n<li>改変した場合はその旨を示す</li>\n<li>著者が利用を推奨していると誤解させない</li>\n</ul>\n<p>商用利用（例：写真の販売、広告への使用、収益化されたサイトでの利用など）は、事前の書面による許可なく<strong>行うことはできません</strong>。</p>\n<p>推奨クレジット例：<em>「Photo © Tim G (@TGthms), licensed under CC BY-NC 4.0.」</em></p>\n<p>透かしの削除、偽の帰属、違法な利用は禁止です。CC BY-NC 4.0 を超える権利が必要な場合はご連絡ください。</p>"
        },
        {
          "id": "software",
          "title": "ソフトウェアとコード",

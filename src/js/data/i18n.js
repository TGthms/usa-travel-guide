...
window.I18N = {
  es: {
    ...
    "settings.unitsSub": "Auto sigue la unidad de temperatura y el sistema de medidas del dispositivo.",
  ...
  zh: {
    ...
    "settings.themeElegant": "典藏画报",
    "settings.themeLuxury": "壮游金典",
    "settings.themeGlass": "暮色琉璃",
    "settings.themeNature": "自然手帐",
    "settings.languageLabel": "多语言",
    "settings.languageSub": "选择你熟悉的语言",
    "settings.unitsLabel": "偏好设置",
    "settings.unitsSub": "“自动”跟随设备的温度单位与度量衡设置。",
  ...
  ja: {
    ...
    "settings.unitsSub": "「自動」は、デバイスの温度単位と単位系の設定に従います。",

 ...
 * English lives in the HTML markup; the i18n engine in runtime.js snapshots it
...
window.I18N = {
  es: {
    ...
    "aria.toggleNav": "Abrir o cerrar el menú de navegación",
    ...
    "hero.desc": "Del Atlántico al Pacífico: un país, historias sin fin.",
    "hero.ctaPrimary": "Comenzar&nbsp;a&nbsp;explorar",
    "hero.ctaKicker": "Empieza el viaje",
    ...
    "dest.openWeather": "Ver el tiempo →",
    ...
    "prac.transport.linkEsta": "Solicitar ESTA",
    "prac.transport.linkCbp": "Info de viaje CBP",
    ...
    "prac.driving.toolLink": "Estimar coste de un viaje por carretera →",
    ...
    "prac.money.toolLink": "Abrir convertidor de divisas →",
    ...
    "prac.health.toolLink": "Números de emergencia útiles →",
    ...
    "seasons.weatherLink": "Ver el tiempo en vivo por ciudad",
    ...
    "tips.parks.linkRec": "Reservas en Recreation.gov",
    "tips.parks.linkNps": "Info de parques en NPS.gov",
    ...
    "tips.tax.toolLink": "Abrir calculadora de propina e impuestos →",
    "tips.distance.toolLink": "Estimar coste de un viaje por carretera →",
    "tips.tipping.toolLink": "Abrir calculadora de propina e impuestos →",
    ...
    "tips.sim.linkAiralo": "eSIM de viaje Airalo",
    "tips.pass.linkUsgs": "Comprar pase (tienda USGS)",
    "tips.pass.linkNps": "Guía de pases NPS",
    "routes.driveToolLink": "Estimar coste de un viaje por carretera →",
    "routes.parksRecLink": "Reservas en Recreation.gov",
    "culture.smithsonian.link": "Smithsonian (gratis)",
    ...
    "gallery.backToGallery": "Volver a la galería",
    ...
    "pageTitle.home": "América — Una Guía de Viaje",
    "pageTitle.gallery": "Galería — América, Una Guía de Viaje",
    "pageTitle.tools": "Herramientas — América, Una Guía de Viaje",
    "pageTitle.weather": "Clima — América, Una Guía de Viaje",
    "pageTitle.currency": "Divisas — América, Una Guía de Viaje",
    "pageTitle.clock": "Reloj mundial — América, Una Guía de Viaje",
    "pageTitle.tip": "Propina e impuestos — América, Una Guía de Viaje",
    "pageTitle.drive": "Coste de viaje — América, Una Guía de Viaje",
    "pageTitle.emergency": "Números útiles — América, Una Guía de Viaje",
    "pageTitle.privacy": "Política de privacidad — América, Una Guía de Viaje",
    "pageTitle.terms": "Términos de uso — América, Una Guía de Viaje",
    ...
    "settings.themeSub": "El sistema sigue tu dispositivo. Clásico y Moderno definen el estilo de la paleta.",
    "settings.themeSystem": "Sistema",
    "settings.appearance": "Apariencia",
    "settings.appearanceLight": "Claro",
    "settings.appearanceDark": "Oscuro",
    "settings.styleLabel": "Estilo",
    "settings.styleClassic": "Clásico",
    "settings.styleModern": "Moderno",
    "settings.auto": "Auto",
    ...
    "settings.unitsSub": "Auto sigue tu región y zona horaria. Elige °C o km para anularlo.",
    ...
    "tools.intro": "Divisas, relojes, propina e impuestos, carretera, tiempo y números de emergencia — abre una herramienta para empezar.",
    ...
    "tools.clockSearch": "Buscar ciudades",
    "tools.clockSearchPlaceholder": "Buscar ciudades…",
    "tools.clockSearchEmpty": "No se encontraron ciudades.",
    ...
    "tools.backToTools": "Volver a herramientas",
    "tools.weatherLabel": "Tiempo",
    "tools.weatherSub": "Ciudades de EE. UU., previsiones y avisos vía NWS; búsqueda mundial, calidad del aire y extras vía Open-Meteo.",
    "weather.search": "Buscar ciudad",
    "weather.searchPlaceholder": "Buscar ciudad de EE. UU. o del mundo…",
    ...
    "gallery.videoBadge": "Vídeo",
    "dest.wxOpen": "Ver el tiempo →",
    "dest.wxH": "Máx",
    "dest.wxL": "Mín",
    "dest.wx.clear": "Despejado",
    "dest.wx.cloud": "Parcialmente nublado",
    "dest.wx.fog": "Niebla",
    "dest.wx.rain": "Lluvia",
    "dest.wx.snow": "Nieve",
    "dest.wx.storm": "Tormenta",
    "dest.wx.generic": "Tiempo",
    "dest.liveWeatherCta": "Tiempo en vivo de esta ciudad →",
    "gallery.placeholder": "Foto aún no añadida",
    "gallery.lbLoading": "Descargando…",
    "gallery.lbPreparing": "Procesando la foto…",
    "gallery.lbAlmost": "Listo",
    "gallery.lbFailed": "No se pudo cargar la foto",
    "tools.sameCurrency": "Misma divisa seleccionada.",
    "tools.updating": "Actualizando…",
    "tools.fetching": "Obteniendo el último tipo de cambio diario disponible.",
    "tools.rateUnavailable": "Tipo de cambio no disponible",
    "tools.checkConnection": "Comprueba tu conexión e inténtalo de nuevo.",
    "tools.ratesDaily": "Los tipos se actualizan a diario.",
    "tools.updatedAsOf": "Actualizado el {date}",
    "tools.tax": "Impuesto",
    "tools.tip": "Propina",
    "tools.driveGal": "gal",
    "tools.driveL": "L",
    "tools.salesTaxZero": "Sin impuesto estatal de ventas (puede haber impuestos locales).",
    "tools.driveMpgMi": "MPG",
    "tools.driveMpgKm": "L/100 km",
    "tools.driveFuelGal": "Combustible $/gal",
    "tools.driveFuelL": "Combustible $/L",
    "tools.driveEvMi": "mi/kWh",
    "tools.driveEvKm": "kWh/100 km",
    "tools.currency.USD": "Dólar estadounidense",
    "tools.currency.EUR": "Euro",
    "tools.currency.GBP": "Libra esterlina",
    "tools.currency.CAD": "Dólar canadiense",
    "tools.currency.AUD": "Dólar australiano",
    "tools.currency.JPY": "Yen japonés",
    "tools.currency.CNY": "Yuan chino",
    "tools.currency.HKD": "Dólar de Hong Kong",
    "tools.currency.CHF": "Franco suizo",
    "tools.currency.MXN": "Peso mexicano",
    "tools.city.Honolulu": "Honolulú",
    "tools.city.Anchorage": "Anchorage",
    "tools.city.LosAngeles": "Los Ángeles",
    "tools.city.Denver": "Denver",
    "tools.city.Chicago": "Chicago",
    "tools.city.NewYork": "Nueva York",
    "tools.city.Toronto": "Toronto",
    "tools.city.MexicoCity": "Ciudad de México",
    "tools.city.SaoPaulo": "São Paulo",
    "tools.city.London": "Londres",
    "tools.city.Paris": "París",
    "tools.city.Berlin": "Berlín",
    "tools.city.Dubai": "Dubái",
    "tools.city.Mumbai": "Bombay",
    "tools.city.Singapore": "Singapur",
    "tools.city.HongKong": "Hong Kong",
    "tools.city.Shanghai": "Shanghái",
    "tools.city.Seoul": "Seúl",
    "tools.city.Tokyo": "Tokio",
    "tools.city.Sydney": "Sídney",
  ...
  zh: {
    ...
    "tips.parks.linkRec": "Recreation.gov 预约",
    "tips.parks.linkNps": "NPS.gov 公园信息",
    "tips.tax.title": "销售税会在结账时另计",
    "tips.tax.body": "与欧洲不同，<strong>标价通常不含税</strong>，销售税因州而异（0%到10%以上不等）。所以，实付金额总会比标价更高一些。",
    "tips.tax.toolLink": "打开小费与销售税计算器 →",
    "tips.distance.toolLink": "估算自驾费用 →",
    "tips.tipping.toolLink": "打开小费与销售税计算器 →",
    "tips.sim.title": "提前备好本地SIM卡",
    "tips.sim.body": "<strong>预付费eSIM</strong>每月约30美元起。若计划深入国家公园等偏远地带，Verizon的信号覆盖表现最为可靠。",
    "tips.sim.linkAiralo": "Airalo 旅行 eSIM",
    "tips.pass.linkUsgs": "购买年票（USGS 商店）",
    "tips.pass.linkNps": "NPS 年票说明",
    "routes.driveToolLink": "估算自驾费用 →",
    "routes.parksRecLink": "Recreation.gov 预约",
    "culture.smithsonian.link": "史密森尼（免费）",
    ...
    "gallery.backToGallery": "返回图库",
    "gallery.pageIntro": "一份持续更新的旅途相册，轻点以显示大图 - 请轻点底部“使用条款”以了解照片版权信息",
    "gallery.searchLabel": "搜索照片",
    "gallery.searchPlaceholder": "搜索标题、城市、州（例如「CA」）、日期…",
    "gallery.sortLabel": "排序",
    "gallery.sortNewest": "最新优先",
    "gallery.sortOldest": "最旧优先",
    "gallery.sortLocation": "地点（城市）",
    "gallery.sortState": "州",
    "gallery.sortCategory": "分类",
    "gallery.loadFull": "加载原图",
    "gallery.loadingFull": "正在加载原图…",
    "gallery.showingFull": "已加载原图",
    "settings.galleryQualityLabel": "相册画质",
    "settings.galleryQualitySub": "设置打开照片时默认加载的清晰度。中等画质兼顾清晰度与流畅；原图为相机原始文件（性能要求较高）。",
    ...
    "gallery.item.goldengatebridge.caption": "Golden Gate Bridge",
    "gallery.item.goldengatebridgewithapelican.caption": "Golden Gate Bridge with a pelican",
    "pageTitle.home": "美国 — 旅行指南",
    "pageTitle.gallery": "相册 — 美国旅行指南",
    "pageTitle.tools": "旅行工具 — 美国旅行指南",
    "pageTitle.weather": "天气 — 美国旅行指南",
    "pageTitle.currency": "汇率 — 美国旅行指南",
    "pageTitle.clock": "世界时钟 — 美国旅行指南",
    "pageTitle.tip": "小费与税 — 美国旅行指南",
    "pageTitle.drive": "自驾费用 — 美国旅行指南",
    "pageTitle.emergency": "常用电话 — 美国旅行指南",
    "pageTitle.privacy": "隐私政策 — 美国旅行指南",
    "pageTitle.terms": "使用条款 — 美国旅行指南",
    "settings.eyebrow": "个性化",
    "settings.heading": "偏好<em>设置</em>",
    "settings.intro": "偏好设置会保存在这台设备上",
    "settings.themeLabel": "主题",
    "settings.themeSub": "“系统”跟随设备。经典与现代决定配色风格。",
    "settings.themeSystem": "跟随系统",
    "settings.appearance": "外观",
    "settings.appearanceLight": "浅色",
    "settings.appearanceDark": "深色",
    "settings.styleLabel": "风格",
    "settings.styleClassic": "经典",
    "settings.styleModern": "现代",
    "settings.auto": "自动",
    "settings.languageLabel": "多语言",
    "settings.languageSub": "选择你熟悉的语言",
    "settings.unitsLabel": "偏好设置",
    "settings.unitsSub": "“自动”跟随你的地区和时区。也可手动选择摄氏度或公里。",
    "settings.temperature": "温度",
    "settings.distance": "距离",
    "settings.miles": "英里",
    "settings.km": "公里",
    "settings.accessibilityLabel": "无障碍",
    "settings.accessibilitySub": "选择动画强度：完整、减弱，或关闭。也可单独关闭光标拖尾效果",
    "settings.reduceMotion": "动画",
    "settings.motionFull": "完整",
    "settings.motionReduced": "减弱",
    "settings.motionOff": "关闭",
    "settings.cursorEffect": "光标拖尾效果",
    "settings.cursorOn": "开启",
    "settings.cursorOff": "关闭",

    "tools.eyebrow": "工具箱",
    "tools.heading": "更从容地<em>规划旅程</em>",
    "tools.intro": "汇率、时钟、小费与销售税、公路费用、天气与紧急电话——打开工具即可开始。",
    ...
    "tools.clockSearch": "搜索城市",
    "tools.clockSearchPlaceholder": "搜索城市…",
    "tools.clockSearchEmpty": "未找到城市。",
    "tools.tipLabel": "小费与销售税",
    "tools.tipSub": "餐厅或购物合计：选择任意美国州以填充预估消费税，再加小费。",
    "tools.bill": "金额 / 账单",
    "tools.tax": "税率 %",
    "tools.tip": "小费 %",
    "tools.taxHint": "税率会按所选州自动填入（综合税率估算），可手动调整。",
    ...
    "tools.backToTools": "返回工具",
    "tools.weatherLabel": "天气",
    "tools.weatherSub": "美国城市预报与预警走 NWS；全球搜索、空气质量与详情补充走 Open-Meteo。",
    "weather.search": "搜索城市",
    "weather.searchPlaceholder": "搜索美国或世界城市…",
    "weather.refresh": "刷新",
    "weather.updated": "更新于",
    ...
    "dest.wx.storm": "雷暴",
    "dest.wx.generic": "天气",
    "dest.liveWeatherCta": "查看该城市实时天气 →",
    "gallery.placeholder": "照片尚未上传",
    "gallery.lbLoading": "下载中…",
    "gallery.lbPreparing": "正在渲染高清照片…",
    "gallery.lbAlmost": "完成",
    "gallery.lbFailed": "高清照片加载失败",
    "tools.sameCurrency": "已选择相同货币。",
    "tools.updating": "更新中…",
    "tools.fetching": "正在获取最新每日汇率。",
    "tools.rateUnavailable": "汇率不可用",
    "tools.checkConnection": "请检查网络连接后重试。",
    "tools.ratesDaily": "汇率每日更新。",
    "tools.updatedAsOf": "更新于 {date}",
    "tools.tax": "税费",
    "tools.tip": "小费",
    "tools.driveGal": "加仑",
    "tools.driveL": "升",
    "tools.salesTaxZero": "该州无州销售税（可能仍有地方税）。",
    "tools.driveMpgMi": "MPG",
    "tools.driveMpgKm": "升/百公里",
    "tools.driveFuelGal": "油价 $/加仑",
    "tools.driveFuelL": "油价 $/升",
    "tools.driveEvMi": "英里/度",
    "tools.driveEvKm": "度/百公里",
    "tools.currency.USD": "美元",
    "tools.currency.EUR": "欧元",
    "tools.currency.GBP": "英镑",
    "tools.currency.CAD": "加拿大元",
    "tools.currency.AUD": "澳大利亚元",
    "tools.currency.JPY": "日元",
    "tools.currency.CNY": "人民币",
    "tools.currency.HKD": "港元",
    "tools.currency.CHF": "瑞士法郎",
    "tools.currency.MXN": "墨西哥比索",
    "tools.city.Honolulu": "火奴鲁鲁",
    "tools.city.Anchorage": "安克雷奇",
    "tools.city.LosAngeles": "洛杉矶",
    "tools.city.Denver": "丹佛",
    "tools.city.Chicago": "芝加哥",
    "tools.city.NewYork": "纽约",
    "tools.city.Toronto": "多伦多",
    "tools.city.MexicoCity": "墨西哥城",
    "tools.city.SaoPaulo": "圣保罗",
    "tools.city.London": "伦敦",
    "tools.city.Paris": "巴黎",
    "tools.city.Berlin": "柏林",
    "tools.city.Dubai": "迪拜",
    "tools.city.Mumbai": "孟买",
    "tools.city.Singapore": "新加坡",
    "tools.city.HongKong": "香港",
    "tools.city.Shanghai": "上海",
    "tools.city.Seoul": "首尔",
    "tools.city.Tokyo": "东京",
    "tools.city.Sydney": "悉尼",
  ...
  ja: {
    ...
    "prac.transport.linkEsta": "ESTA を申請",
    "prac.transport.linkCbp": "CBP の渡航情報",
    ...
    "prac.driving.toolLink": "ロードトリップ費用を見積もる →",
    ...
    "prac.money.toolLink": "通貨コンバーターを開く →",
    ...
    "seasons.weatherLink": "都市のライブ天気を見る",
    ...
    "tips.parks.linkRec": "Recreation.gov で予約",
    "tips.parks.linkNps": "NPS.gov の公園情報",
    ...
    "tips.tax.toolLink": "チップと売上税の計算機を開く →",
    "tips.distance.toolLink": "ロードトリップ費用を見積もる →",
    "tips.tipping.toolLink": "チップと売上税の計算機を開く →",
    ...
    "tips.sim.linkAiralo": "Airalo 旅行eSIM",
    "tips.pass.linkUsgs": "パスを購入（USGSストア）",
    "tips.pass.linkNps": "NPS パスガイド",
    "routes.driveToolLink": "ロードトリップ費用を見積もる →",
    "routes.parksRecLink": "Recreation.gov 予約",
    "culture.smithsonian.link": "スミソニアン（無料）",
    ...
    "gallery.item.goldengatebridge.caption": "Golden Gate Bridge",
    "gallery.item.goldengatebridgewithapelican.caption": "Golden Gate Bridge with a pelican",
    "pageTitle.home": "アメリカ — 旅行ガイド",
    "pageTitle.gallery": "ギャラリー — アメリカ旅行ガイド",
    "pageTitle.tools": "旅行ツール — アメリカ旅行ガイド",
    "pageTitle.weather": "天気 — アメリカ旅行ガイド",
    "pageTitle.currency": "通貨 — アメリカ旅行ガイド",
    "pageTitle.clock": "世界時計 — アメリカ旅行ガイド",
    "pageTitle.tip": "チップと税 — アメリカ旅行ガイド",
    "pageTitle.drive": "ロードトリップ費用 — アメリカ旅行ガイド",
    "pageTitle.emergency": "緊急連絡先 — アメリカ旅行ガイド",
    "pageTitle.privacy": "プライバシーポリシー — アメリカ旅行ガイド",
    "pageTitle.terms": "利用規約 — アメリカ旅行ガイド",
    ...
    "settings.themeSub": "「システム」はデバイスに従います。クラシックとモダンで配色の雰囲気が決まります。",
    "settings.themeSystem": "システム",
    "settings.appearance": "外観",
    "settings.appearanceLight": "ライト",
    "settings.appearanceDark": "ダーク",
    "settings.styleLabel": "スタイル",
    "settings.styleClassic": "クラシック",
    "settings.styleModern": "モダン",
    "settings.auto": "自動",
    "settings.languageLabel": "言語",
    "settings.languageSub": "地域や都市の詳細情報を含め、ガイド全体を翻訳します。",
    "settings.unitsLabel": "単位設定",
    "settings.unitsSub": "「自動」は地域とタイムゾーンに従います。°C や km は手動で選べます。",
    ...
    "tools.intro": "為替、時計、チップと売上税、ロード費用、天気、緊急連絡先 — ツールを開いて使えます。",
    ...
    "tools.clockSearch": "都市を検索",
    "tools.clockSearchPlaceholder": "都市を検索…",
    "tools.clockSearchEmpty": "都市が見つかりません。",
    ...
    "tools.backToTools": "ツールに戻る",
    "tools.weatherLabel": "天気",
    "tools.weatherSub": "米国の都市の予報と警報は NWS、世界検索・大気質・詳細の補完は Open-Meteo。",
    "weather.search": "都市を検索",
    "weather.searchPlaceholder": "米国や世界の都市を検索…",
    "weather.refresh": "更新",
    "weather.updated": "更新",
    ...
    "gallery.videoBadge": "ビデオ",
    "dest.wxOpen": "天気を見る →",
    "dest.wxH": "最高",
    "dest.wxL": "最低",
    "dest.wx.clear": "晴れ",
    "dest.wx.cloud": "晴れ時々曇り",
    "dest.wx.fog": "霧",
    "dest.wx.rain": "雨",
    "dest.wx.snow": "雪",
    "dest.wx.storm": "嵐",
    "dest.wx.generic": "天気",
    "dest.liveWeatherCta": "この都市の天気を見る →",
    "gallery.placeholder": "写真はまだ追加されていません",
    "gallery.lbLoading": "ダウンロード中…",
    "gallery.lbPreparing": "フルサイズを描画中…",
    "gallery.lbAlmost": "完了",
    "gallery.lbFailed": "読み込みに失敗しました",
    "tools.sameCurrency": "同じ通貨が選択されています。",
    "tools.updating": "更新中…",
    "tools.fetching": "最新の為替レートを取得しています。",
    "tools.rateUnavailable": "レートを取得できません",
    "tools.checkConnection": "接続を確認して再度お試しください。",
    "tools.ratesDaily": "レートは毎日更新されます。",
    "tools.updatedAsOf": "{date} 更新",
    "tools.tax": "税金",
    "tools.tip": "チップ",
    "tools.driveGal": "ガロン",
    "tools.driveL": "L",
    "tools.salesTaxZero": "州の売上税はありません（地方税がかかる場合あり）。",
    "tools.driveMpgMi": "MPG",
    "tools.driveMpgKm": "L/100km",
    "tools.driveFuelGal": "燃料 $/gal",
    "tools.driveFuelL": "燃料 $/L",
    "tools.driveEvMi": "mi/kWh",
    "tools.driveEvKm": "kWh/100km",
    "tools.currency.USD": "米ドル",
    "tools.currency.EUR": "ユーロ",
    "tools.currency.GBP": "英ポンド",
    "tools.currency.CAD": "カナダドル",
    "tools.currency.AUD": "オーストラリアドル",
    "tools.currency.JPY": "日本円",
    "tools.currency.CNY": "中国元",
    "tools.currency.HKD": "香港ドル",
    "tools.currency.CHF": "スイスフラン",
    "tools.currency.MXN": "メキシコペソ",
    "tools.city.Honolulu": "ホノルル",
    "tools.city.Anchorage": "アンカレッジ",
    "tools.city.LosAngeles": "ロサンゼルス",
    "tools.city.Denver": "デンバー",
    "tools.city.Chicago": "シカゴ",
    "tools.city.NewYork": "ニューヨーク",
    "tools.city.Toronto": "トロント",
    "tools.city.MexicoCity": "メキシコシティ",
    "tools.city.SaoPaulo": "サンパウロ",
    "tools.city.London": "ロンドン",
    "tools.city.Paris": "パリ",
    "tools.city.Berlin": "ベルリン",
    "tools.city.Dubai": "ドバイ",
    "tools.city.Mumbai": "ムンバイ",
    "tools.city.Singapore": "シンガポール",
    "tools.city.HongKong": "香港",
    "tools.city.Shanghai": "上海",
    "tools.city.Seoul": "ソウル",
    "tools.city.Tokyo": "東京",
    "tools.city.Sydney": "シドニー",

...
window.I18N = {
  es: {
    ...
    "settings.liquidGlassLabel": "Liquid Glass",
    "settings.liquidGlassSub": "Material de cristal líquido para paneles y tarjetas. Usa más GPU si está disponible; desactivado mantiene el aspecto por defecto.",
    "settings.liquidGlassOff": "Desactivado",
    "settings.liquidGlassOn": "Activado",
    "settings.liquidGlassClear": "Claro",
    "settings.liquidGlassTinted": "Tintado",
  ...
  zh: {
    ...
    "settings.unitsSub": "应用于气温显示与自驾路线的距离计量等",
    ...
    "settings.liquidGlassLabel": "液态玻璃",
    "settings.liquidGlassSub": "为面板与卡片提供液态玻璃材质。在可用时会占用更多 GPU；关闭则保持默认外观。",
    "settings.liquidGlassOff": "关闭",
    "settings.liquidGlassOn": "开启",
    "settings.liquidGlassClear": "通透",
    "settings.liquidGlassTinted": "着色",
  ...
  ja: {
    ...
    "settings.liquidGlassLabel": "リキッドガラス",
    "settings.liquidGlassSub": "パネルやカード向けのリキッドガラス素材。利用可能な場合はGPUを多めに使います。オフなら従来どおりの見た目です。",
    "settings.liquidGlassOff": "オフ",
    "settings.liquidGlassOn": "オン",
    "settings.liquidGlassClear": "クリア",
    "settings.liquidGlassTinted": "ティント",

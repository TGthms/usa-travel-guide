...
window.I18N = {
  es: {
    ...
    "tools.weatherSub": "Ciudades de EE. UU., previsiones y calidad del aire — datos en vivo (Open-Meteo).",
    ...
    "weather.done": "Listo",
    "weather.attribution": "Datos: Open-Meteo (CC BY 4.0). Solo orientativo; no uses esto en emergencias.",
  ...
  zh: {
    ...
    "tools.weatherSub": "美国城市预报与空气质量 — Open-Meteo 实时数据。",
    "weather.search": "搜索城市",
    ...
    "weather.close": "关闭",
    "weather.done": "完成",
    "weather.attribution": "数据来源：Open-Meteo（CC BY 4.0）。仅供参考，紧急情况请勿依赖。",
  ...
  ja: {
    ...
    "tools.weatherSub": "米国の都市の予報と大気質 — Open-Meteo のリアルタイムデータ。",
    ...
    "weather.close": "閉じる",
    "weather.done": "完了",
    "weather.attribution": "データ: Open-Meteo（CC BY 4.0）。参考情報であり、緊急時には使用しないでください。",
